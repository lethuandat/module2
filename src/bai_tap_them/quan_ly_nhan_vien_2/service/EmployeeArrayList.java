...
public class EmployeeArrayList {
    ...
    //Khi kích thước đầy thì tự tạo mảng mới sao chép các giá trị mảng cũ và kích thước tăng lên 150%
    ...
    //Array lưu được đối tượng và nguyên thủy, tốc độ nhanh hơn
